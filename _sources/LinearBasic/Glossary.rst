...
.. dragndrop:: Match_chap3
    :feedback: Incorrect
    :match_1: algorithm|||a generic, step-by-step list of instructions for solving a problem
    ...
    :match_3: deque|||an ordered collection of items with two ends and the items remain positioned in the collection. New items can be added at either the front or the rear
    :match_4: first-in first-out (FIFO)||| ordering principle in which the first item added is also the first removed
    :match_5: linear data structure||| a data structure with elements that have positions relative to each other
    :match_6: palindrome|||a string that reads the same forward and backward
    ...
    :match_9: Drag me to 3|||I am 3
    :match_10: Drag me to 1|||I am 1
    :match_11: Drag me to 2|||I am 2
    :match_12: Drag me to 3|||I am 3
    :match_13: Drag me to 1|||I am 1
    :match_14: Drag me to 2|||I am 2
    :match_15: Drag me to 3|||I am 3
