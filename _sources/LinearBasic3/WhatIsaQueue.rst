...
:ref:`Figure 1 <fig_qubasicqueue>` shows a simple queue of string objects.
...
.. figure:: Figures/basicqueue.png
   ...
   Figure 1: A Queue of String objects


Computer science also has common examples of queues. Consider a computer
laboratory with 30 computers networked to a single printer. When
